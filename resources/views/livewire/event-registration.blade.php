<div class="relative flex w-full flex-col min-h-screen py-6 justify-between text-white/50">
    ...
    <div class="mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-y-4 mx-auto w-full max-w-3xl">
            ...
            <div class="flex flex-col gap-y-4 px-4 text-center">
                <h1 class="text-2xl sm:text-3xl dark:text-gray-50 font-bold tracking-tight text-balance">
                    {{$event->name}}
                </h1>
                <section class="flex flex-col gap-y-4 justify-center items-center">
                    <p class="text-base sm:text-lg font-medium text-pretty w-full sm:w-96">
                        {{$event->address}}
                    </p>
